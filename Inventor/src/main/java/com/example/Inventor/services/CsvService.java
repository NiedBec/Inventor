        ...
        try (Reader reader = new BufferedReader(new InputStreamReader(file.getInputStream()))) {
            ...
            while ((nextRecord = csvReader.readNext()) != null) {
                ...
                if (nextRecord[0].equals("csname")) {
                    ...
                    informationOS.setReport_id(report); // Берем на основе созданного репорта
                    informationOSRepository.save(informationOS);

                    // Обработка информации для Location
                    Location location = new Location();
                    location.setCabinet("test");
                    location.setCity("test");
                    location.setHouse("45a(test)");
                    location.setStreet("test");
                    location.setReport_id(report); // Берем на основе созданного репорта
                ...
                if (nextRecord[0].equals("UUID")) {
                    ...
                    uuidEntity.setReport_id(report);
                ...
                if (nextRecord[0].equals("Материнская плата")) {
                    ...
                    motherboard.setReport_id(report);
                ...
                if (nextRecord[0].equals("DeviceID")) {
                    ...
                    while (!Objects.equals(tmpRecord[0], "Оперативная память")){
                        ...
                        logicalDrive.setReport_id(report);
